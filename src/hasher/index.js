...
var hasher_worker = 'function hashData(e,t){var n=new jsSHA(e,"TEXT"),r=n.getHash("SHA-512","B64").replace("/","-");t(r)}function hashFileentry(e){var t=new FileReader;t.onload=function(){hashData(this.result,function(t){e.hash=t,self.postMessage(["hashed",e])})},t.readAsBinaryString(e.file)}importScripts("../lib/sha512.js"),self.onmessage=function(e){var t=e.data[1];switch(e.data[0]){case"hash":hashFileentry(t)}};'

hasher_worker = lib_sha512 + hasher_worker;

hasher_worker = new Blob([hasher_worker]);
